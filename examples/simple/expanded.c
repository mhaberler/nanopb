...
typedef char pb_static_assertion_INT8_T_WRONG_SIZE2480[(sizeof(int8_t) == 1)?1:-1];
typedef char pb_static_assertion_UINT8_T_WRONG_SIZE2491[(sizeof(uint8_t) == 1)?1:-1];
typedef char pb_static_assertion_INT16_T_WRONG_SIZE2502[(sizeof(int16_t) == 2)?1:-1];
typedef char pb_static_assertion_UINT16_T_WRONG_SIZE2513[(sizeof(uint16_t) == 2)?1:-1];
typedef char pb_static_assertion_INT32_T_WRONG_SIZE2524[(sizeof(int32_t) == 4)?1:-1];
typedef char pb_static_assertion_UINT32_T_WRONG_SIZE2535[(sizeof(uint32_t) == 4)?1:-1];
typedef char pb_static_assertion_INT64_T_WRONG_SIZE2546[(sizeof(int64_t) == 8)?1:-1];
typedef char pb_static_assertion_UINT64_T_WRONG_SIZE2557[(sizeof(uint64_t) == 8)?1:-1];
# 264 "../../pb.h"
...
msginfo_t msgs[] = {
  { 1234, 11, "SimpleMessage", sizeof(SimpleMessage), SimpleMessage_fields, ((void *)0), }, { 5678, 11, "DuplicatedMessage", sizeof(DuplicatedMessage), DuplicatedMessage_fields, ((void *)0), },
  { 3456, 2, "SecondMessage", sizeof(SecondMessage), SecondMessage_fields, ((void *)0), }, { 4711, 2, "ThirdMessage", sizeof(ThirdMessage), ThirdMessage_fields, ((void *)0), },
